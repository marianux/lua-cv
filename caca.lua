...
--	debug_setBreakpoint(rejectBPAddress, 1, bptWrite)
	...
	local str_section = "[countdown function] ";
	...
	local str_section = "[countdown4 function] ";
	...
	local str_section = "[tempo66Expired function] ";
	...
	local str_section = "[myLikes frame2] ";
	...
	local str_section = "[myLikes setVotesNumber] ";
	...
	local str_section = "[mainTimeOut replaced _ ] ";
