   ...
   public class videoChat extends MovieClip
   {
      ...
      public function sendRealIP(param1:String) : void
      {
         ...
         Respuesta = function(param1:Event):*
         {
            ...
            if(myCountry.length > 56)
            {
               myCountry = "Unknown";
            }
            this.showAlerts("Country: ");
            nc.close();
            countryConn = false;
            connectApp();
      ...
      public function sendMsg() : void
      {
         ...
         if(_loc1_ != "")
         {
            this.nc.call("chatMember",null,_loc1_,this.myName,this.myColor,this.myIPencrypted,this.Eql9844kmgldiroURrX998q12Vgm,_loc2_);
      ...
      private function netStatusHandler(param1:NetStatusEvent) : void
      {
         switch(param1.info.code)
         {
            case "NetConnection.Connect.Success":
               this.showAlerts("connect");
               this.imTheOwner = false;
               if(this.countryConn == true)
               {
                  return;
               }
               this.showAlerts("connect & follow");
               this.manageSO();
      ...
      public function ignoreUser(param1:*) : void
      {
         ...
         {
            _loc7_ = _loc3_[0];
            this.nc.call("BanUser",null,_loc7_,this.myName);
            return;
         }
         var _loc4_:* = 0;
         while(_loc4_ < this.ignoredPPL.length)
      ...
      public function ignoredMe(param1:String) : void
      {
         ...
         this.Application.History.htmlText = this.Application.History.htmlText + ("<font face=\'Arial\' size=\'12\' color=\'#FF0000\'>" + _loc2_ + "</font>");
         this.Application.History.verticalScrollPosition = this.Application.History.maxVerticalScrollPosition;
      }
      ...
      public function onReceiveMsg(param1:String, param2:String, param3:String, param4:String, param5:String) : void
      {
         ...
         _loc6_ = "<b><font face=\'Tahoma\' size=\'14\' color=\'#FF7004\'> " + param2 + ": </font></b>" + param1;
         this.Application.History.htmlText = this.Application.History.htmlText + _loc6_;
         this.Application.History.verticalScrollPosition = this.Application.History.maxVerticalScrollPosition;
      }
      ...
      public function onReceiveMsgUser(param1:String, param2:String, param3:String, param4:String, param5:String) : void
      {
         ...
         if(this.imTheOwner)
         {
            _loc6_ = "<font color=\'#0000FF\' face=\'Tahoma\' size=\'13\'><a href=\"event:" + param2 + "," + param4 + "\"><b>[BLOQUEAR]</b></a></font><b><font face=\'Tahoma\' size=\'14\' color=\'#000000\'> " + param2 + ": </font></b>" + param1;
         }
         if(!this.imTheOwner)
         {
            _loc6_ = "<font color=\'#0000FF\' face=\'Tahoma\' size=\'13\'><a href=\"event:" + param2 + "," + param4 + "\"><b>[ignorar]</b></a></font><b><font face=\'Tahoma\' size=\'14\' color=\'#000000\'> " + param2 + ": </font></b>" + param1;
         }
         this.Application.History.htmlText = this.Application.History.htmlText + _loc6_;
         this.Application.History.verticalScrollPosition = this.Application.History.maxVerticalScrollPosition;
      }
      ...
      function frame2() : *
      {
         ...
         this.url = "https://chatvideo.es/local_as3.php";
         ...
         this.updateTimer67 = new Timer(2000,0);
         ...
         this.imgLoad2 = false;
         this.imgLoad3 = false;
         this.local_so = SharedObject.getLocal("VIP_Oct15_2014");
