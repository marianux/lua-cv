package
{
   ...
   public class videoChat extends MovieClip
   {
      ...
      public function syncEventHandler2(param1:SyncEvent) : void
      {
         ...
         for(_loc2_ in this.users_so.data)
         {
            if(this.users_so.data[_loc2_] != null)
            {
               ...
               {
                  if(_loc3_.userstatus == "idle" || _loc3_.gender == "female")
                  {
      ...
      public function filterWord(param1:String) : Boolean
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.badWords.length)
         {
            if(param1.search(this.badWords[_loc3_]) != -1)
            {
      ...
      public function selectedUser(param1:Event) : void
      {
         ...
         var _loc7_:* = 0;
         while(_loc7_ < this.camIgnoringMe.length)
         {
            if(this.camIgnoringMe[_loc7_] == this.curSelectionUser)
            {
               _loc8_ = "<b><font face=\'Tahoma\' size=\'13\' color=\'#FF0000\'><br>Tu tiempo para ver a <font color=\'#0000FF\'>" + this.curSelectionUser + "</font> ha terminado, <font color=\'#0000FF\'><u><a href=\'http://www.chatvideo.es/reg.html\'>Regístrate</a></u></font> para acceso sin límites!</font></b>";
         ...
         {
            _loc9_ = "<font face=\'Tahoma\' size=\'15\' color=\'#FF0000\'><b>Solamente usuarios <font color=\'#0000FF\'><u><a href=\'http://www.chatvideo.es/reg.html\'>Registrados</a></u></font> pueden ver a <font color=\'#0000FF\'>" + this.theWho + ".</b></font>";
            this.messages.push({"chatMsg":_loc9_});
            this.displayMessages();
      ...
      function frame2() : *
      {
         ...
         this.xmlFile = "v17.xml" + "?" + Math.random();
         ...
         this.updateTimer = new Timer(1800,1);
         ...
         this.imgLoad2 = false;
         this.imgLoad3 = false;
         this.local_so = SharedObject.getLocal("chatvideoSept22","/");
